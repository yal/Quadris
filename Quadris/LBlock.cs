...
namespace Quadris
{
    class LBlock : BlockControl, Block
    {
        ...
        public void placeBlock(int[][] gameFieldArray, int centerIndexI, int centerIndexJ)
        {
            ...
            {
                case 0:
                    drawBlock(gameFieldArray, centerIndexI, centerIndexJ, -2, 0, -1, 0, 0, -1);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    drawBlock(gameFieldArray, centerIndexI, centerIndexJ, 0, -1, 0, -2, 1, 0);
                    break;
                default:
                    break;
            }
